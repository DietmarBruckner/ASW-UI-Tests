...
Activate OPCUA Client Server With Anonymous Access
    [Documentation]    Scenario: Replicate TM611_3_1 activation flow for OPC UA/CS
    ...                Traceability ID: FW-OPCUA-C4
    ...                Component: OPC UA CS
    ...                Source Manual:
    ...                Source Section: TM611_3_1_ActivateOPCUACS
    ...
    [Tags]             opcua    configuration    security    trace:fw-opcua-c4    trace:tm611
    Initialize Automation Studio
    Activate OPCUA Client Server With Anonymous Access    ${UACS_VERSION}
    Build Project
    Log    OPC UA client/server activation and anonymous access configured successfully
...
Configure OPCUA RBAC Roles Users And Default Permissions
    ...
    Initialize Automation Studio
    Configure OPCUA RBAC Roles Users And Default Permissions    ${UACS_VERSION}
    Build Project
